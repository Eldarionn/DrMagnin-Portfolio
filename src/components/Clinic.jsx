      ...
      >
        <div className="w-full pb-[15%]">
          <p className="text-[20px] md:text-[30px] lg:text-[50px] uppercase mx-[15%] text-center text-white ">
            <span className="text-[35px] md:text-[45px] lg:text-[75px]">P</span>
            lanifiez une consultation dans notre clinique
          </p>
          <p className="font-raleway text-[10px] md:text-[15px] lg:text-[25px] leading-[15px] md:leading-[30px] lg:leading-[50px] uppercase my-1 mb-14 md:my-5 lg:my-10 w-[85%] mx-auto py-6 px-[7%] text-center text-white">
        ...
        <div className="absolute bottom-[-45%] left-1/2 transform -translate-x-1/2  py-8 px-12  bg-black/60 backdrop-blur-lg border-[4px] border-white">
