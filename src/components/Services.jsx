...
const Services = () => {
  return (
    <div id="services" className="hidden lg:block px-[2%]">
      ...
      <div className="hidden lg:grid grid-cols-3 h-[800px]  overflow-hidden gap-5">
        ...
        <Link to="facelift">
          <div className="relative h-full w-full overflow-hidden grayscale hover:grayscale-0 cursor-pointer group">
            ...
            <p className="absolute  text-center bottom-[25%] text-white left-1/2 -translate-x-1/2 text-[30px] opacity-0 transition-opacity duration-700 group-hover:opacity-100 flex w-full h-full p-[5%] flex-col items-center justify-end">
              <span className="uppercase  leading-[100px] font-[600] underline">
                Facelift
              </span>
              <br />
